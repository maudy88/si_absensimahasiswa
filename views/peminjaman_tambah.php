<?php
$nope=$_GET['nope'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_nama WHERE no_buku ='$nope'") or die ("SQL Edit error");
...
if($_POST){
    ...
    $no_buku=$_POST['nama_mhs'];
	$peminjam=$_POST['peminjam'];
	$tglPinjam=$_POST['tglPinjam'];
    $ket=$_POST['ket'];
    //buat sql
    $sql="INSERT INTO peminjaman VALUES ('$nama_mhs','$peminjam','$tglPinjam','Belum Kembali','','$ket','')";
	$sqlBuku="UPDATE tbl_nama SET status='Dipinjam' WHERE no_buku='$nope'";
