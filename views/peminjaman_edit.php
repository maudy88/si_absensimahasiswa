                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="nope" class="col-sm-3 control-label">Nim</label>
                             <div class="col-sm-9">
								<input type="text" name="nope" value="<?=$data['nim']?>"class="form-control" id="inputEmail3" placeholder="Nomor Perkara" readonly="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="peminjam" class="col-sm-3 control-label">Nama Mahasiswa</label>
                            <div class="col-sm-9">
                                <input type="text" name="peminjam" value="<?=$data['nama_mhs']?>"class="form-control" id="inputEmail3" placeholder="Nama Peminjam">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success">
                                    <span class="fa fa-edit"></span> Update Data Mata Kuliah</button>
                            </div>
                        </div>
                    </form>
...
if($_POST){
    ...
    $ket=$_POST['ket'];
    //buat sql
    $sql="UPDATE peminjaman SET  = '$nim', peminjam='$nama_mhs', tgl_pinjam='$jm_masuk', tgl_kembali='$jm_keluar', lama_pinjam='$lamapinjam',
